...
export function rebuildUnified() {
  logger.info('Vereinheitlichte Assets werden neu aufgebaut');
  // Reset unified table
  ...
  logger.debug('Daten für Neuaufbau geladen', {
  ...
  for (const source of sources) {
    ...
    logger.debug('Verarbeite Quellzeilen für Neuaufbau der Vereinheitlichung', {
      sourceId: source.id,
  ...
  logger.info('Vereinheitlichte Assets neu aufgebaut', {
