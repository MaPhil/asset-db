...
export const buildAssetStructure = () => {
  ...
  categories.forEach((category) => {
    ...
    const measureTopicTitle = normaliseText(topic?.measure?.title);
    if (measureTopicTitle) {
      topic.title = measureTopicTitle;
      topic.displayTitle = measureTopicTitle;
    }
    ...
    const measureSubTopicTitle = normaliseText(subTopic?.measure?.title);
    if (measureSubTopicTitle) {
      subTopic.title = measureSubTopicTitle;
      subTopic.displayTitle = measureSubTopicTitle;
    }
